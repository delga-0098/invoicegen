...
from invoicegen.models import BusinessInfo, Address, ContactInfo
...
def default_business(business_address: dict, business_contact: dict) -> BusinessInfo:
    return BusinessInfo(name="Forma Construction", address=Address(**business_address), contact=ContactInfo(**business_contact), logo="logo.jpg", license_number="CSLB #1234567", tax_id="XX-XXXXXXX")

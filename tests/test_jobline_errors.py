...
@pytest.mark.parametrize(
    "field",
    ["address", "unit", "description", "dates", "paid"],
    ids=["address", "unit", "description", "dates", "paid"],
)
...
@pytest.mark.parametrize(
    "raw",
    ["2025-12-36", "naskd", "1234/123/9083"],
    ids=["ISO", "invalid-date-format1", "invalid-date-format2"],
)
...
@pytest.mark.parametrize(
    "raw", ["invalid", date(2023, 12, 30)], ids=["source_row-str", "source_row-date"]
)
